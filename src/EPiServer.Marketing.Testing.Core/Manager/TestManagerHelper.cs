    ...
    internal static class TestManagerHelper
    {
        ...
        internal static IMarketingTest ConvertToManagerTest(IABTest theDalTest)
        {
            var aTest = new ABTest
            {
                ...
                ExpectedVisitorCount = theDalTest.ExpectedVisitorCount,
                ActualVisitorCount = theDalTest.ActualVisitorCount,
        ...
        internal static IABTest ConvertToDalTest(IMarketingTest theManagerTest)
        {
            var aTest = new DalABTest
            {
                ...
                ExpectedVisitorCount = theManagerTest.ExpectedVisitorCount,
                ActualVisitorCount = theManagerTest.ActualVisitorCount,
