...
namespace EPiServer.Marketing.Testing.Web.Queries
{
    ...
    public class ArchivedTestsQuery : IContentQuery
    {
        ...
        {
            get { return "Archived A/B Tests"; } //return _localizationService.GetString("/versionstatus/rejected"); }
        }
        ...
        {
            var contents = QueryHelper.GetTestContentList(_contentRepository, TestState.Archived);
