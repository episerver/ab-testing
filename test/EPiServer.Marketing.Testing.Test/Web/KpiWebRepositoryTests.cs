...
namespace EPiServer.Marketing.Testing.Test.Web
{
    public class KpiWebRepositoryTests
    {
        ...
        public void ActivateKpiInstance_returns_commerce_kpi_when_kpiType_is_commerce()
        {
            ...
            kpiInstanceData.Add("kpiType", "EPiServer.Marketing.KPI.Commerce.Kpis.PurchaseItemKpi, EPiServer.Marketing.KPI.Commerce, Version=2.3.1.0, Culture=neutral, PublicKeyToken=8fe83dea738b45b7");
            var webRepo = GetUnitUnderTest();
        ...
        {
            Dictionary<string, string> kpiInstanceData = new Dictionary<string, string>();
            kpiInstanceData.Add("kpiType", "EPiServer.Marketing.KPI.Commerce.Kpis.AverageOrderKpi, EPiServer.Marketing.KPI.Commerce, Version=2.3.1.0, Culture=neutral, PublicKeyToken=8fe83dea738b45b7");
            var webRepo = GetUnitUnderTest();
            var result = webRepo.ActivateKpiInstance(kpiInstanceData);
