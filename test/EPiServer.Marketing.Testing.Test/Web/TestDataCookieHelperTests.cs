...
namespace EPiServer.Marketing.Testing.Test.Web
{
    public class TestDataCookieHelperTest
    {
        ...
        private AdminConfigTestSettings _settings = new AdminConfigTestSettings();
        ...
        public void GetTestDataFromCookie_Returns_Correct_Values_For_Active_Test_From_Populated_Response_Cookie()
        {
            ...
            var testCookie = new HttpCookie(mockTestDataCookiehelper.COOKIE_PREFIX + testContentId.ToString() + _settings.CookieDelimeter + "en-GB")
            {
        ...
        //    var testCookie = new HttpCookie(mockTestDataCookiehelper.COOKIE_PREFIX + testContentId.ToString() + _settings.Object.CookieDelimeter + "en-GB")
        //    {
        //        ["start"] = startDate.ToString(),
        //        ["vId"] = "1",
        //        ["viewed"] = "false",
        ...
        //        + _settings.Object.CookieDelimeter + "en-GB")
        //    {
        //        ["start"] = startDate.ToString(),
        //        ["vId"] = "0",
        //        ["viewed"] = "True",
        ...
        //    _httpContextHelper.Verify(hch => hch.AddCookie(It.Is<HttpCookie>(c => c.Name == mockTestDataCookiehelper.COOKIE_PREFIX + tdCookie.TestContentId + _settings.Object.CookieDelimeter + "en-GB")));
        ...
        //    var cookieKey = mockTestDataCookiehelper.COOKIE_PREFIX + originalCookie.TestContentId.ToString() + _settings.Object.CookieDelimeter + "en-GB";
        ...
        //    var cookieKey = testDataCookieHelper.COOKIE_PREFIX + tdCookie.TestContentId.ToString() + _settings.Object.CookieDelimeter + "en-GB";
        ...
        //    var testCookie = new HttpCookie(cookieHelper.COOKIE_PREFIX + testContentId.ToString() + _settings.Object.CookieDelimeter + "en-GB")
        ...
        //    var aCookieName = cookieHelper.COOKIE_PREFIX + aCookieData.TestContentId.ToString() + _settings.Object.CookieDelimeter + "en-GB";
        //    _epiHelper.Setup(call => call.GetContentCultureinfo()).Returns(new CultureInfo("en-GB"));
